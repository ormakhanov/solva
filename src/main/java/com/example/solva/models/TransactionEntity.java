...
public class TransactionEntity {
    ...
    public TransactionEntity(String accountFrom, String accountTo, CurrencyShortnameEnum currencyShortname, BigDecimal sum, CategoryEnum category, String dateTime, boolean limitExceeded, LimitEntity limitEntity) {
